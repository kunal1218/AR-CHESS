...
def build_piece_voice_line_query(
    ...
    return (
        ...
        "The line must sound like clear natural spoken English that a real character would actually say aloud. "
...
def build_piece_voice_line_repair_query(
    ...
    return (
        ...
        + "Keep the same piece personality and board context, but make it feel complete, natural, and speakable. "
        + "Prefer the clearest and most sensible line over the most exaggerated character bit. "
